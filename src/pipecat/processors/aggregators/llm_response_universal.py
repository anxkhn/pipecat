...
class LLMUserAggregator(LLMContextAggregator):
    ...
    async def cleanup(self):
        ...
        Guaranteed teardown hook: cancels the realtime handoff flush task and
        tears down the turn, idle, VAD, and mute controllers/strategies. See the
...
class LLMAssistantAggregator(LLMContextAggregator):
    ...
    async def cleanup(self):
        ...
        Guaranteed teardown hook: cancels in-flight on_context_updated callback
        tasks and tears down the summarizer. See the Processor Lifecycle section
        in CONTRIBUTING.md.
        """
        await super().cleanup()
        await self._cleanup()
