...
class AudioBufferProcessor(FrameProcessor):
    ...
    async def start_recording(self):
        ...
        Initializes recording state and resets audio buffers. Triggers the
        ``on_recording_started`` event when recording was not already active.
        """
        started = not self._recording
